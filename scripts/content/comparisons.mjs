...
//  - The trial is CARDLESS (since 2026-08-06, migration 20260926) — "no card
//    required" is accurate again; never claim a card is needed to START the
//    trial. Enforced by scripts/__tests__/blogPosts.test.js.
//
