...
export function buildExtractionPrompt(message) {
  return [
    "You are reading a message sent to a screen-printing / embroidery shop.",
    "Record what it asks for using the record_extraction tool. Rules:",
    "- Copy the customer's own words into the *_text fields; do not paraphrase away detail.",
