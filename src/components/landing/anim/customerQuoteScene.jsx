...
import { useSprite, Sprite } from "./engine.jsx";
...
const FM = '"Inter", system-ui, -apple-system, sans-serif';
    ...
    <div style={{ padding: '40px 0 28px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 20, width: 1100, marginTop: 36 }}>
        {[
          ...
          <div key={c.n} style={{
            background: CQ.surface, border: `1px solid ${CQ.border}`, borderRadius: 0,
            padding: '22px 24px', display: 'flex', flexDirection: 'column', alignItems: 'center',
          }}>
            <div style={{
              width: 36, height: 36, borderRadius: 0, background: CQ.accent, color: '#fff',
...
function PricingBar({ label, perPc, total, accentGreen = false, opacity = 1, transform = '' }) {
  return (
    <div style={{
      opacity, transform,
      background: CQ.navy, color: '#fff', borderRadius: 0,
      ...
      <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'baseline', gap: 16 }}>
        ...
        <div style={{ fontFamily: FF, fontSize: 26, fontWeight: 800, letterSpacing: '-0.02em', color: accentGreen ? '#86A89A' : '#fff' }}>${total}</div>
      </div>
    </div>
  );
}
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        fontFamily: '"Anton", "Oswald", sans-serif', fontSize: 132, color: CQ.darkText1,
        letterSpacing: '0.01em', textTransform: 'uppercase', lineHeight: 1, textAlign: 'center',
      }}>Customer quotes,</div>
      <div style={{
        opacity: h2T, transform: `translateY(${(1-h2T)*10}px)`,
        fontFamily: '"Anton", "Oswald", sans-serif', fontSize: 132, color: '#86A89A',
        letterSpacing: '0.01em', textTransform: 'uppercase', lineHeight: 1.02, textAlign: 'center', marginTop: 8,
      }}>on your site.</div>
      ...
      <div style={{ height: '100%', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ width: 1100, margin: '0 auto', position: 'relative' }}>
          <div style={{
            ...
            borderRadius: 0, padding: '22px 28px',
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr auto', gap: 18, alignItems: 'end' }}>
              <div>
                ...
                <div style={{
                  height: 46, border: `1px solid ${CQ.borderStrong}`, borderRadius: 0, background: '#fff',
              ...
              <button style={{
                height: 46, padding: '0 24px', borderRadius: 0, border: 'none',
                background: '#E8F0EA', color: CQ.accent, fontFamily: FF, fontSize: 15, fontWeight: 700,
              }}>Go</button>
            </div>
                ...
                {garments.map((g, i) => {
                  ...
                  return (
                    <div key={g.num} style={{
                      ...
                      <div style={{ width: 44, height: 44, display: 'grid', placeItems: 'center', background: '#F1F5F9', borderRadius: 0 }}>
          ...
          {previewVis > 0 && (
            <div style={{
              ...
              background: '#fff', border: `1px solid ${CQ.border}`, borderRadius: 0,
              padding: 18, width: 260,
              boxShadow: '0 24px 60px rgba(15,23,42,0.22), 0 4px 12px rgba(15,23,42,0.08)',
              zIndex: 5,
            }}>
              <div style={{ background: '#F8FAFC', borderRadius: 0, padding: '14px 8px', display: 'grid', placeItems: 'center' }}>
          ...
          <div style={{ marginTop: 18, display: 'flex', alignItems: 'center', gap: 16 }}>
            {selectedT < 1 ? (
              <div style={{
                ...
                background: CQ.amberSoft, border: `1px solid ${CQ.amberBorder}`, borderRadius: 0,
                fontFamily: FF, fontSize: 14, fontWeight: 500, color: CQ.amber,
              }}>Select a garment style</div>
            ) : (
              <div style={{
                flex: 1, padding: '14px 18px',
                background: CQ.greenSoft, border: `1px solid #86A89A`, borderRadius: 0,
    ...
    <ShopChrome opacity={1}>
      <div style={{ height: '100%', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ width: 1100, margin: '20px auto 0', flex: 1, display: 'flex', flexDirection: 'column', gap: 18, paddingBottom: 24, overflow: 'hidden' }}>
          {/* Style header strip */}
          <div style={{
            background: CQ.surface, border: `2px solid ${CQ.accent}`, borderRadius: 0,
            padding: '14px 22px',
            display: 'flex', alignItems: 'center', gap: 14,
          }}>
            <div style={{ width: 36, height: 36, borderRadius: 0, background: '#F1F5F9', display: 'grid', placeItems: 'center' }}>
          ...
          {/* COLOR section */}
          <div style={{ background: CQ.surface, border: `1px solid ${CQ.border}`, borderRadius: 0, padding: '20px 24px' }}>
              ...
              {colors.map((c, i) => {
                ...
                return (
                  <div key={c.name} style={{
                    ...
                    borderRadius: 0, padding: '14px 8px 10px',
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 28 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                ...
                <div style={{ border: `1px solid ${CQ.borderStrong}`, borderRadius: 0, padding: '8px 12px', fontFamily: FF, fontSize: 13, fontWeight: 600, color: CQ.text1, background: '#fff' }}>Front</div>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                <div style={{ fontFamily: FF, fontSize: 12, color: CQ.text3 }}>Technique</div>
                <div style={{ border: `1px solid ${CQ.borderStrong}`, borderRadius: 0, padding: '8px 12px', fontFamily: FF, fontSize: 13, fontWeight: 600, color: CQ.text1, background: '#fff' }}>Screen Print</div>
              </div>
                ...
                return (
                  <div key={s.label} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6 }}>
                    ...
                    <div style={{
                      ...
                      borderRadius: 0, display: 'grid', placeItems: 'center',
    ...
    <ShopChrome opacity={1}>
      <div style={{ height: '100%', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ width: 1100, display: 'flex', alignItems: 'center', gap: 8 }}>
            {['Configure', 'Details', 'Review'].map((lbl, i) => {
              ...
              return (
                <React.Fragment key={lbl}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                    <div style={{ width: 12, height: 12, borderRadius: 0, background: done || active ? color : 'transparent', border: `2px solid ${color}` }} />
        ...
        <div style={{ width: 1100, margin: '24px auto 0', opacity: formT, transform: `translateY(${(1-formT)*10}px)` }}>
          ...
          <div style={{ background: CQ.surface, border: `1px solid ${CQ.border}`, borderRadius: 0, padding: '28px 32px' }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 22, columnGap: 28, rowGap: 22 }}>
              ...
              <div>
                ...
                <div style={{
                  height: 50, border: `1px solid ${CQ.borderStrong}`, borderRadius: 0, background: '#fff',
              ...
              <div>
                ...
                <div style={{
                  height: 86, border: `1px solid ${CQ.borderStrong}`, borderRadius: 0, background: '#fff',
                  padding: '12px 14px',
            ...
            <div style={{ marginTop: 20, display: 'flex', alignItems: 'center', gap: 10 }}>
              <div style={{ width: 18, height: 18, borderRadius: 0, border: `1.5px solid ${CQ.borderStrong}`, background: '#fff' }} />
          ...
          <div style={{ marginTop: 22, display: 'flex', justifyContent: 'flex-end' }}>
            <button style={{
              padding: '14px 26px', borderRadius: 0, border: 'none',
              background: reviewT > 0.5 ? CQ.accent : '#E2E8F0',
              color: reviewT > 0.5 ? '#fff' : CQ.text3,
              fontFamily: FF, fontSize: 15, fontWeight: 700,
              boxShadow: reviewT > 0.5 ? '0 6px 18px rgba(44,88,64,0.32)' : 'none',
              transition: 'all 0.2s',
      ...
      <div style={{ height: '100%', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ width: 1100, margin: '0 auto', flex: 1, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24, paddingBottom: 24 }}>
            ...
            <Card>
              ...
              <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', alignItems: 'center' }}>
                {[['S',20],['M',20],['L',20],['XL',20]].map(([s,q]) => (
                  <div key={s} style={{
                    padding: '6px 12px', border: `1px solid ${CQ.border}`, borderRadius: 0,
          ...
          <div style={{
            ...
            background: CQ.navy, color: '#fff', borderRadius: 0, padding: 28,
            display: 'flex', flexDirection: 'column',
            ...
            <div style={{
              ...
              background: '#15803D', borderRadius: 0,
            ...
            <button style={{
              marginTop: 22, padding: '18px 24px', borderRadius: 0, border: 'none',
              background: CQ.accent, color: '#fff',
              fontFamily: FF, fontSize: 17, fontWeight: 700,
              boxShadow: `0 12px 28px rgba(44,88,64,${0.28 + 0.18*submitPulse * submitT})`,
...
function Card({ children }) {
  return (
    <div style={{ background: CQ.surface, border: `1px solid ${CQ.border}`, borderRadius: 0, padding: '22px 24px' }}>
      {children}
    </div>
  );
}
...
function SceneCQSuccess() {
  ...
  const confetti = React.useMemo(() => Array.from({length: 22}, (_, i) => {
    ...
    return {
      x: (seed * 37) % 1100 - 200,
      y: ((seed * 17) % 380) + 60,
      hue: ['#2C5840','#86A89A','#16A34A','#86A89A','#F59E0B','#86A89A','#EC4899'][i % 7],
      sz: 6 + (seed % 5),
      delay: 0.3 + (i % 7) * 0.05,
    };
  }), []);
    ...
    <ShopChrome opacity={pageT}>
      <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '0 40px' }}>
          ...
          {confetti.map((c, i) => {
            ...
            return (
              <div key={i} style={{
                ...
                left: `calc(50% + ${c.x}px)`,
                top: c.y + tt * 320,
                width: c.sz, height: c.sz, borderRadius: 0,
                background: c.hue,
        ...
        <div style={{
          ...
          border: `1px solid ${CQ.border}`, borderRadius: 0, padding: 24,
