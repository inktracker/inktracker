...
export const DEFAULT_WIZARD_STYLES = [
  ...
  { id:"ls-heavy", garment:"Long Sleeve", styleNumber:"5060", brand:"AS Colour", tag:"Heavy",
  ...
  { id:"cn-relax", garment:"Crewnecks", styleNumber:"5161", brand:"AS Colour", tag:"Relax",
    hoverDescription:"Relaxed fit, heavyweight crew" },
...
export default function OrderWizard({ onSubmit, styles: stylesProp, shopOwner, shop }) {
  ...
  const [enrichedPreviews, setEnrichedPreviews] = useState({
    ...
    "ls-heavy":     { styleImage: "", name: "AS Colour 5060", description: "Heavy L/S Tee", weight: "" },
    ...
    "cn-relax":     { styleImage: "", name: "AS Colour 5161", description: "Relax Crew", weight: "" },
