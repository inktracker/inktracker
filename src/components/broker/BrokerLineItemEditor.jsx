...
// SanMar product titles lead with the brand name, which would print twice in
// "Brand — style — title" labels. Whole-word, display-only.
// See LineItemEditor.jsx stripLeadingBrand.
...
export default function BrokerLineItemEditor({
  ...
  // Standard adult grid plus any non-standard sizes (infant/toddler) the
  // line already carries — mirrors LineItemEditor's gridSizes.
  const gridSizes = [
    ...SIZES,
