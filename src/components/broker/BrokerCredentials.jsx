            ...
            <div key={c.type} className="bg-white border border-slate-200 rounded-2xl p-5">
                ...
                {c.fields.includes("number") && (
                  <div>
                    ...
                    <input
                      ...
                      className="w-full text-sm border border-slate-200 rounded-lg px-3 py-2 bg-white focus:outline-none focus:ring-2 focus:ring-teal-300 disabled:bg-slate-50 disabled:text-slate-500"
                    />
                  </div>
                )}
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <button
                  ...
                  className="text-sm font-semibold bg-teal-600 hover:bg-teal-700 disabled:bg-teal-300 text-white px-3 py-2 rounded-lg"
                >
