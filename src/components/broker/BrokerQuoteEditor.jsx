...
// Render a PDF generated by exportQuoteToPDF in a new tab instead of
// triggering a download. Some browsers (notably Safari mobile) block
// window.open after async work, so we open the window synchronously
// and navigate it once the blob URL is ready.
