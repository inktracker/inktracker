      ...
      <div className="max-w-md mx-auto bg-white rounded-2xl border border-slate-200 shadow-sm p-6 sm:p-8">
          ...
          {hostShop?.shop_name ? (
            <>
              ...
              <p className="text-sm text-slate-500 mt-1">
                Tell us your name and pick a password — then you'll be ready to use the shop.
              </p>
            </>
          ) : (
            <>
        ...
        <div className="rounded-2xl border border-slate-200 p-4 mb-5">
          ...
          <p className="text-xs text-slate-500 mb-4">
            You signed in from your invite email — set a password so you can sign in directly next time.
          </p>
