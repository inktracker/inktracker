...
5. **Turn on 2FA** (strongly recommended): the signup wizard offers it on the "Protect Your Account" step — one click, enter the 6-digit code we email you, done. (Skipped it? Account → Security → Enable email sign-in code.) Tick "Remember this device" at sign-in to skip the code on your own computer for 30 days.
